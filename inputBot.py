...
rid = int(input("Enter Your Registration Number : ")) 
...
def rosen():
    ...
    class45 = driver.find_element_by_xpath('//*[@id="calendar"]/div[2]/div/table/tbody/tr/td/div/div/div[3]/table/tbody/tr/td[2]/div/div[2]/a[6]/div/div[2]')
    class45.click()
...
schedule.every().thursday.at("14:46").do(m0304)
...
schedule.every().thursday.at("14:58").do(rosen)
